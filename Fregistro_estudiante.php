      ...
      <div class="testimonial">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>REGISTRO DE ESTUDIANTES ACTIVOS</h2>
                  </div>
               </div>
            </div>
            <div class="row">
            <div class="col-md-12">
               ...
               <table border="0" align="center">
                  ...
                  <td><input class="contactus" type="text" id="txtnombre"  name="txtnombre" placeholder="Escribe tu nombre completo" size="30" maxLength="30"></td>
                  </tr>
                  <tr>
