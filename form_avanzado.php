...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Desarrollo Software 2</title>
                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                 <li class="nav-item">
                                    <div class="sign_btn"><a href="index.html">Inicio</a></div>
                                 </li>
                                 <li class="nav-item">
                                    <div class="sign_btn"><a href="formulario1.php">Formulario 1</a></div>
                                 </li>
                                 <li class="nav-item">
                                    <div class="sign_btn"><a href="Fregistro_estudiante.php">Formulario 2</a></div>
                                 </li>
                                 <li>
                                    <div class="sign_btn"><a href="form_avanzado.php">Formulario Avanzado</a></div>         
                                 </li>
                              </ul>
            ...
            <section class="banner_main">
               <div class="container-fluid">
                  <div class="row d_flex">
                     <div class="col-md-5">
                        <div class="text-bg">
                           <h1>Instituto Nacional <br>de Jucuapa</h1>
                           <strong>Desarrollo de Software 2</strong>
                           <span>Facilitador: Lic. Roberto García</span>
                           <!--<a href="#">Buy Now</a>-->
                        </div>
                     </div>
            ...
            <div class="row d_flex">
               <div class="col-md-6">
                  <div class="two_box_img">
                     <figure><img src="images/leptop.jpeg" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="two_box_img">
                     <h2><span class="offer">2022 </span>Historia</h2>
                     <p>El Instituto Nacional de Jucuapa es una institución de Educación Media, del sector público con una planta docente de 40 maestros/as. En el departamento de Usulután, Municipio Jucuapa. Fue fundada en al año de 1966 y hasta el día de hoy es considerada una de las mejores instituciones a nivel departamental, contando con diferentes especialidades de estudio.</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="testimonial">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>FORMULARIO AVANZADO CON BOOTSTRAP</h2>
                  </div>
               </div>
            </div>
            <div class="row">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                        ...
                                        <input type="text" name="direccion" class="form-control" id="direccion" placeholder="" value="" required>
                                        <div class="valid-feedback">¡Ok válido!</div>
                                        <div class="invalid-feedback">Complete el campo.</div> 
                                </div>
                            ...
                            <div class="form-row">
                                <div>
                                    <label for="date">Fecha de Nacimiento</label>
                                        <input type="date" name="date" class="form-control" id="date" placeholder="" value="" required>
                                        <div class="valid-feedback">¡Ok válido!</div>
                                        <div class="invalid-feedback">Complete el campo.</div>
                                </div>
                            </div>
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <p>Docente: Lic. Roberto Antonio García</p>
                     </div>
                  </div>
               </div>
            </div>
